fetch("../back/?tabla=heroe")													// Cargo un endpoint en el back
...
.then(function(datos){															// Y cuando reciba datos
	...
	datos.forEach(function(dato){
		...
		instancia.querySelector("h4").textContent = dato.texto	instancia.querySelector("article").style.background = "url(data:image/png;base64,"+dato.imagen+")"
