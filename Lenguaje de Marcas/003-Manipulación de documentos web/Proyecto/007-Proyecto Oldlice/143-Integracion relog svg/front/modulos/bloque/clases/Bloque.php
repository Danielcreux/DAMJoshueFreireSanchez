<?php
/* Contiene las funciones que tiene cada bloque creado en en el front con sus variables definidas, también como se mostrará cada bloque según como lo tenemos en base de datos establecidos */
