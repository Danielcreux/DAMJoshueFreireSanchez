...
ruta_archivo = "C:/xampp/htdocs/programacion/DAMJoshueFreireSanchez/Programación/009-Gestion de base de datos/Proyectos/Tomato/cargaampliadamas.txt"
...
plt.legend()
plt.savefig("C:/xampp/htdocs/programacion/DAMJoshueFreireSanchez/Programación/009-Gestion de base de datos/Proyectos/Tomato/carga_cpu.jpg")
plt.close()
...
plt.ylabel('Porcentaje de Uso')
plt.legend()
plt.savefig("C:/xampp/htdocs/programacion/DAMJoshueFreireSanchez/Programación/009-Gestion de base de datos/Proyectos/Tomato/carga_ram.jpg")
plt.close()
...
plt.ylabel('Porcentaje de Uso')
plt.legend()
plt.savefig("C:/xampp/htdocs/programacion/DAMJoshueFreireSanchez/Programación/009-Gestion de base de datos/Proyectos/Tomato/carga_disco.jpg")
plt.close()
...
plt.legend()
plt.savefig("C:/xampp/htdocs/programacion/DAMJoshueFreireSanchez/Programación/009-Gestion de base de datos/Proyectos/Tomato/carga_red.jpg")
plt.close()
