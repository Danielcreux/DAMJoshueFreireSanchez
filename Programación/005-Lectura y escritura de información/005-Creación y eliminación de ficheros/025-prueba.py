...
class Cliente:  # Creo una clase
    def __init__(self, nuevonombre, nuevosapellidos, nuevoemail, nuevadireccion):  # Constructor con parámetros
...
print("##################################")
print("Programa agenda v0.1 por Jose Vicente Carratalá")  # Mensaje de bienvenida
print("##################################")
